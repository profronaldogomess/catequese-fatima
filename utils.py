...
def formatar_data_br(valor):
    ...
    # Caso 3: Tenta via Pandas (Fallback)
    try:
...
def calcular_idade(data_nascimento):
    ...
    hoje = date.today()
    try:
        # Usa o formatador para garantir que temos uma data válida para o cálculo
