            ...
            if st.form_submit_button("💾 SALVAR INSCRIÇÃO"):
                if nome and contato and etapa_inscricao != "SEM TURMAS":
                    ...
                    registro = [[
                        ...
                        obs_familia       # AD: obs_pastoral_familia
                    ]]
                ...
                if not filtro_dados.empty:
                    ...
                    with tab_edit:
                        with st.form("form_edicao_30_colunas_v6"):
                            st.subheader("📍 1. Identificação e Status")
                            c1, c2 = st.columns([2, 1])
                            ...
                            if st.form_submit_button("💾 SALVAR ALTERAÇÕES NO BANCO DE DADOS", use_container_width=True):
                                lista_up = [
                                    ...
                                    ed_contato, ed_end, ed_mae, ed_pai, ed_resp, ed_doc, 
                                    dados.get('engajado_grupo', 'N/A'), ed_status, ed_med, ed_tgo, 
                                    dados.get('estado_civil_pais_ou_proprio', 'N/A'), dados.get('sacramentos_ja_feitos', 'N/A'),
                                    ed_prof_m, ed_tel_m, ed_prof_p, ed_tel_p, dados.get('est_civil_pais', 'N/A'), 
                                    dados.get('sac_pais', 'N/A'), dados.get('participa_grupo', 'NÃO'), 
                                    dados.get('qual_grupo', 'N/A'), dados.get('tem_irmaos', 'NÃO'), 
